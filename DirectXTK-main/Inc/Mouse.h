...
namespace ABI { namespace Windows { namespace UI { namespace Helpers { struct ICoreWindow; } } } }
#endif
...
namespace DirectX
{
    ...
    #ifdef USING_COREWINDOW
        void __cdecl SetWindow(ABI::Windows::UI::Helpers::ICoreWindow* window);
    #ifdef __cplusplus_winrt
        void __cdecl SetWindow(Windows::UI::Helpers::CoreWindow^ window)
        {
            // See https://msdn.microsoft.com/en-us/library/hh755802.aspx
            SetWindow(reinterpret_cast<ABI::Windows::UI::Helpers::ICoreWindow*>(window));
        }
    #endif
    #ifdef CPPWINRT_VERSION
        void __cdecl SetWindow(winrt::Windows::UI::Helpers::CoreWindow window)
        {
            // See https://docs.microsoft.com/en-us/windows/uwp/cpp-and-winrt-apis/interop-winrt-abi
            SetWindow(reinterpret_cast<ABI::Windows::UI::Helpers::ICoreWindow*>(winrt::get_abi(window)));
        }
    #endif
