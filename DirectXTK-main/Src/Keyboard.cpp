...
private:
    ...
    static HRESULT Activated(IInspectable*, ABI::Windows::UI::Helpers::IWindowActivatedEventArgs*)
    {
    ...
    static HRESULT AcceleratorKeyEvent(IInspectable*, ABI::Windows::UI::Helpers::IAcceleratorKeyEventArgs* args)
    {
...
void Keyboard::SetWindow(ABI::Windows::UI::Helpers::ICoreWindow* window)
{
