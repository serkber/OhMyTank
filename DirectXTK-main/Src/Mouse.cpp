...
public:
    ...
    void SetMode(Mode mode)
    {
        ...
        using namespace ABI::Windows::UI::Helpers;
    ...
    bool IsVisible() const noexcept
    {
        ...
        ComPtr<ABI::Windows::UI::Helpers::ICoreCursor> cursor;
    ...
    void SetWindow(ABI::Windows::UI::Helpers::ICoreWindow* window)
    {
        using namespace Microsoft::WRL;
        using namespace Microsoft::WRL::Wrappers;
        using namespace ABI::Windows::Foundation;
...
private:
    ...
    ComPtr<ABI::Windows::UI::Helpers::ICoreWindow> mWindow;
    ComPtr<ABI::Windows::Devices::Input::IMouseDevice> mMouse;
    ComPtr<ABI::Windows::UI::Helpers::ICoreCursor> mCursor;
    ...
    static HRESULT PointerEvent(IInspectable*, ABI::Windows::UI::Helpers::IPointerEventArgs* args)
    {
        using namespace ABI::Windows::Foundation;
    ...
    static HRESULT PointerWheel(IInspectable*, ABI::Windows::UI::Helpers::IPointerEventArgs* args)
    {
        using namespace ABI::Windows::Foundation;
        using namespace ABI::Windows::UI::Input;
        using namespace ABI::Windows::Devices::Input;
    ...
    static HRESULT ActivatedEvent(IInspectable*, ABI::Windows::UI::Helpers::IWindowActivatedEventArgs*)
    {
        if (!s_mouse)
            return S_OK;
...
void Mouse::SetWindow(ABI::Windows::UI::Helpers::ICoreWindow* window)
{
    pImpl->SetWindow(window);
}
